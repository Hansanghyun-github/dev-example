...
nohup java -jar -Dserver.port=${TARGET_PORT} -Dspring.profiles.active=dev build/libs/dev-example-0.0.1-SNAPSHOT.jar >> ../logs/was_out.log 2> ../logs/was_err.log < /dev/null &
